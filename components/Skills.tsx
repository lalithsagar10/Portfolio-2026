  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-3 max-w-lg text-sm text-stone-500 dark:text-stone-400 sm:text-base">
            ...
            <div key={group.title}>
              ...
              <ul className="mt-4 flex flex-wrap gap-2">
                {group.items.map((item) => (
                  <li
                    key={item}
                    className="rounded-xl border border-stone-200/90 bg-white/70 px-3.5 py-2 text-sm text-stone-700 shadow-sm dark:border-stone-700/80 dark:bg-stone-900/40 dark:text-stone-200"
                  >
                    {item}
                  </li>
                ))}
